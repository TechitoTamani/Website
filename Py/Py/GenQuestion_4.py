...
def Q4(section,document,Ansdoc):

  from docx import Document
  import random

  question = "section วัตถุหนึ่งเคลื่อนที่ด้วยความเร็ว u m/s เมื่อเวลาผ่านไป t วินาที ความเร็วของวัตถุเปลี่ยนเป็น v m/s จงหาความเร่งเฉลี่ย".split()
